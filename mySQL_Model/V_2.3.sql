...
INSERT INTO `agence` VALUES (0,'Agence1','Adresse1'),(1,'Agence2','Adresse2');
...
CREATE TABLE `est_stationne` (
  ...
  `idPreparateur` int(11) NOT NULL,
  `date` date DEFAULT NULL,
  PRIMARY KEY (`idVehicule`,`idParking`,`idPreparateur`),
  KEY `fk_Vehicule_has_Parking_Parking1_idx` (`idParking`),
  KEY `fk_Vehicule_has_Parking_Vehicule1_idx` (`idVehicule`),
  KEY `fk_Est_Stationné_Operateur1_idx` (`idPreparateur`),
  CONSTRAINT `fk_Est_Stationné_Operateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `preparateur` (`idPreparateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Vehicule_has_Parking_Parking1` FOREIGN KEY (`idParking`) REFERENCES `parking` (`idParking`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Vehicule_has_Parking_Vehicule1` FOREIGN KEY (`idVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `livraison` (
  ...
  KEY `fk_Livraison_Preparateur1_idx` (`idPreparateur`),
  KEY `fk_Livraison_Vehicule1_idx` (`idVehicule`),
  CONSTRAINT `fk_Livraison_Preparateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `operateur` (`idOperateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Livraison_Vehicule1` FOREIGN KEY (`idVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `operateur` (
  ...
  UNIQUE KEY `idPreparateur_UNIQUE` (`idOperateur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `operateur` VALUES (1,'Operateur1'),(2,'');
...
INSERT INTO `parking` VALUES (1,'Nom1'),(2,'Nom2');
...
CREATE TABLE `preparateur` (
  ...
  UNIQUE KEY `idOperateur_UNIQUE` (`idPreparateur`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `preparateur` VALUES (1,'Preparateur1','Agence1'),(2,'Preparateur2','Agence2'),(3,'Preparateur3','Agence3');
...
CREATE TABLE `preparation` (
  ...
  UNIQUE KEY `idPreparateur_UNIQUE` (`idPreparateur`),
  KEY `fk_Preparation_Preparateur1_idx` (`idPreparateur`),
  KEY `fk_Preparation_Vehicule1_idx` (`idVehicule`),
  CONSTRAINT `fk_Preparation_Preparateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `operateur` (`idOperateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Preparation_Vehicule1` FOREIGN KEY (`idVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `preparation` VALUES (1,1,1,'2015-07-15',0,'MonsieurOperateur','Preparateur1');
...
CREATE TABLE `process_check_in` (
  ...
  `idPreparateur` int(11) NOT NULL,
  `idVehicule` int(11) NOT NULL,
  `Vehicule_exterieur` int(11) NOT NULL,
  ...
  KEY `fk_Process_Check_in_Operateur1_idx` (`idPreparateur`),
  KEY `fk_Process_Check_in_Vehicule1_idx` (`idVehicule`),
  KEY `fk_Process_Check_in_Vehicule_exterieur1_idx` (`Vehicule_exterieur`),
  CONSTRAINT `fk_Process_Check_in_Operateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `preparateur` (`idPreparateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Process_Check_in_Vehicule1` FOREIGN KEY (`idVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Process_Check_in_Vehicule_exterieur1` FOREIGN KEY (`Vehicule_exterieur`) REFERENCES `vehicule_exterieur` (`idVehicule_ext`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `process_f44` (
  ...
  UNIQUE KEY `Numero_UNIQUE` (`Numero`),
  KEY `fk_Process_F44_Vehicule1_idx` (`idVehicule`),
  KEY `fk_Process_F44_Operateur1_idx` (`idPreparateur`),
  CONSTRAINT `fk_Process_F44_Operateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `preparateur` (`idPreparateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Process_F44_Vehicule1` FOREIGN KEY (`idVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `recuperation` (
  ...
  `idPreparateur` int(11) NOT NULL,
  `iidVehicule` int(11) NOT NULL,
  `prev_date` date DEFAULT NULL,
  `accompli` tinyint(1) DEFAULT NULL,
  `nomOperateur` varchar(45) DEFAULT NULL,
  `nomPreparateur` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idRecuperation`,`idPreparateur`,`iidVehicule`),
  KEY `fk_Recuperation_Preparateur1_idx` (`idPreparateur`),
  KEY `fk_Recuperation_Vehicule1_idx` (`iidVehicule`),
  CONSTRAINT `fk_Recuperation_Preparateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `operateur` (`idOperateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Recuperation_Vehicule1` FOREIGN KEY (`iidVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `transfert` (
  ...
  KEY `fk_Transfert_Preparateur1_idx` (`idPreparateur`),
  KEY `fk_Transfert_Vehicule1_idx` (`idVehicule`),
  CONSTRAINT `fk_Transfert_Preparateur1` FOREIGN KEY (`idPreparateur`) REFERENCES `operateur` (`idOperateur`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_Transfert_Vehicule1` FOREIGN KEY (`idVehicule`) REFERENCES `vehicule` (`idVehicule`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (0,'admin','$2a$10$QPS5x7o77TfyFRxgkBggw.mfTqcXd3q3KrGmaT5p3xh8ihRfGWi9m','administrateur'),(1,'root','$2a$10$IDV9u8xbLic5vhZ1dATzZ.z56yZ995xseqZc5vkeWpqPIQ94FZqv6','administrateur');
...
CREATE TABLE `vehicule_exterieur` (
  `idVehicule_ext` int(11) NOT NULL,
  `immat` varchar(45) DEFAULT NULL,
  `mva` varchar(45) DEFAULT NULL,
  `modele` varchar(45) DEFAULT NULL,
...
CREATE TABLE `voiture_à_récuperer` (
  `idVoiture_à_récuperer` int(11) NOT NULL,
  `idPreparateur` varchar(45) DEFAULT NULL,
  `idVehicule` varchar(45) DEFAULT NULL,
  `immat` varchar(45) DEFAULT NULL,
  `num_contrat` varchar(45) DEFAULT NULL,
  `idParking` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2015-07-13 12:44:22
