...
CREATE TABLE `vehicules` (
  ...
  `INDICATIF_PROPRIO_CORP_LICENSEE` varchar(45) DEFAULT NULL,
  `CURRENT_LOCATION_STN` int(11) DEFAULT NULL,
  `DATE_DE_LIVRAISON` varchar(45) DEFAULT NULL,
  `STATUT` varchar(45) DEFAULT NULL,
  `KILOMETERS` int(11) DEFAULT NULL,
  `MARSHALL_DATE` varchar(45) DEFAULT NULL,
  `DESCRIPTION_VHL` varchar(45) DEFAULT NULL,
  `CODE_VEHICULE` varchar(45) DEFAULT NULL,
  `CATEGORIE_VHL` varchar(45) DEFAULT NULL,
  `MANUFACTURER_CODE` varchar(45) DEFAULT NULL,
  `WIZ_BODY_TYPE_CODE` varchar(45) DEFAULT NULL,
  `COULEUR` varchar(45) DEFAULT NULL,
  `DATE_ACHAT` varchar(45) DEFAULT NULL,
  `MISSING_DATE` int(11) DEFAULT NULL,
  `DATE_SORTIE_PREVUE` varchar(45) DEFAULT NULL,
  `REG_COUNTRY_CODE` varchar(45) DEFAULT NULL,
  ...
  `PREFIX_NUMERO_CONTRAT` varchar(45) DEFAULT NULL,
  `NUMERO_CONTRAT` int(11) DEFAULT NULL,
  `INDICATEUR_STATION_DEPART_CORPORATE_LICENSEE` varchar(45) DEFAULT NULL,
  `INDICATEUR_STATION_RETOUR_CORPORATE_LICENSEE` varchar(45) DEFAULT NULL,
  `INDICATEUR_MOYEN_DE_PAIEMENT` varchar(45) DEFAULT NULL,
  `CATGORIE_FACTUREE` varchar(45) DEFAULT NULL,
  `INDICATEUR_OPEN_MVT` varchar(45) DEFAULT NULL,
  `DATE_DEPART_PRECEDENT_CONTRAT` varchar(45) DEFAULT NULL,
  `DATE_RETOUR_PRECEDENT_CONTRAT` varchar(45) DEFAULT NULL,
  `PREFIX_NUMERO_CONTRAT_PRECEDENT` varchar(45) DEFAULT NULL,
  `NUMERO_CONTRAT_PRECEDENT` int(11) DEFAULT NULL,
  `INDICATEUR_CORP_LIC_PAGD_PRECEDENT` varchar(45) DEFAULT NULL,
  `INDICATEUR_CORP_LIC_PAGR_PRECEDENT` varchar(45) DEFAULT NULL,
  ...
  `DATE_ADDITION_VHL_DS_WIZARD` varchar(45) DEFAULT NULL,
  ...
  `concessionnaire` varchar(45) DEFAULT NULL,
  `ville` varchar(45) DEFAULT NULL,
  `position` varchar(45) DEFAULT NULL,
  `immo` int(11) DEFAULT NULL,
  `statut_immo_5j` varchar(45) DEFAULT NULL,
  `VP_VU` varchar(45) DEFAULT NULL,
  `nbre_mois_d_tention` int(11) DEFAULT NULL,
  `km_mois` int(11) DEFAULT NULL,
  `km` int(11) DEFAULT NULL,
  `mois_livraison` varchar(45) DEFAULT NULL,
  `Agence_retour` varchar(45) DEFAULT NULL,
  `Statut_VO` varchar(45) DEFAULT NULL,
  `marque` varchar(45) DEFAULT NULL,
  `d_lai_VO` int(11) DEFAULT NULL,
  `retard_sortie_VO_wizard` varchar(45) DEFAULT NULL,
  `libell_mod_le` varchar(45) DEFAULT NULL,
  `km_maxi` varchar(45) DEFAULT NULL,
  `km_maxi_par_mois` varchar(45) DEFAULT NULL,
  `KM_d_pass` varchar(45) DEFAULT NULL,
  `d_classement` varchar(45) DEFAULT NULL,
  `dur_e_contrat` int(11) DEFAULT NULL,
  `km_en_cours_d_pass` varchar(45) DEFAULT NULL,
  `type` varchar(45) DEFAULT NULL,
  `dur_e` int(11) DEFAULT NULL,
  `type_dur_e_courte_moyenne` varchar(45) DEFAULT NULL,
  `statut_VO_mensuel` varchar(45) DEFAULT NULL,
  `contrat_nrt` varchar(45) DEFAULT NULL,
  `POSITION_CDG_ORY` varchar(45) DEFAULT NULL,
  `agence_retour_CDG_ORY` varchar(45) DEFAULT NULL,
  `proprio_agence_retour` varchar(45) DEFAULT NULL,
  `one_way` varchar(45) DEFAULT NULL,
  `cat_reformat_e` varchar(45) DEFAULT NULL,
  `Date_du_fichier` varchar(45) DEFAULT NULL,
